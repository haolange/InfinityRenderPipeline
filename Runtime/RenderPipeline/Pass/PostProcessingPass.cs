    ...
    public partial class InfinityRenderPipeline
    {
        ...
        void ComputeBloom(Camera camera, in RGTextureRef sceneColorTexture, in RGTextureRef bloomTexture)
        {
            using (RGComputePassRef passRef = m_RGBuilder.AddComputePass<BloomPassData>(ProfilingSampler.Get(CustomSamplerId.ComputeBloom)))
            {
                ...
                // Provisional: no exposure stage, so the threshold is raw linear luminance.
        ...
        void ComputePostCombine(Camera camera, in RGTextureRef sceneColorTexture, in RGTextureRef bloomTexture, in RGTextureRef postProcessTexture)
        {
