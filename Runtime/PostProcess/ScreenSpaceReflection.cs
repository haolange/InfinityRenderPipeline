...
namespace InfinityTech.Rendering.PostProcess
{
    ...
    public class ScreenSpaceReflection : VolumeComponent, IInfinityVolumeActivity
    {
        ...
        public ClampedFloatParameter fade = new ClampedFloatParameter(0.05f, 0.05f, 0.25f);
