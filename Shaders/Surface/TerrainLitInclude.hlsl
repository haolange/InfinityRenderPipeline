...
VertexPositionInputs GetVertexPositionInputs(float3 positionOS)
{
    ...
    input.positionCS = mul(Matrix_ViewJitterProj, float4(input.positionWS, 1.0));
...
Varyings SplatmapVert(Attributes v)
{
    ...
    half3 viewDirWS = _WorldSpaceCameraPos - Attributes.positionWS;
    #if !SHADER_HINT_NICE_QUALITY
        viewDirWS = SafeNormalize(viewDirWS);
    #endif
    ...
    #endif
        o.fogFactorAndVertexLight.x = 0;
        o.fogFactorAndVertexLight.yzw = 0;
